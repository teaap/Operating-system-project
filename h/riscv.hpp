...
public:
    ...
    static void argumenti();

    static void povratna(size_t arg);
...
inline void Riscv::argumenti(){
    __asm__ volatile ("ld s1,10*8(fp)");
    __asm__ volatile ("ld s2,11*8(fp)");
    __asm__ volatile ("ld s3,12*8(fp)");
    __asm__ volatile ("ld s4,13*8(fp)");
    __asm__ volatile ("ld s5,14*8(fp)");
}

inline void Riscv::povratna(size_t arg){
    __asm__ volatile ("sd %0, 10*8(fp)" : : "r" (arg));
}
